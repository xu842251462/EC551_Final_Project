...
HD_PWD='X:/EC551/FinalProject/ec551_final29/ec551_final28.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Game.tcl -notrace
